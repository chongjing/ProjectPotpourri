...
setwd("/rds/user/cx264/hpc-work/project/2.Jeongmin/01.Saskia//4.DEanalysis/04.pho2HP-myc_vs_mock/")
...
library(stringr)
library(statmod)
my_count_matrix <- read.csv("01.raw.count.pho2HP-myc_vs_mock.tab", sep = "\t", header=T)
