...
setwd("/rds/user/cx264/hpc-work/project/2.Jeongmin/01.Saskia//4.DEanalysis/02.pho2LP-myc_vs_mock/")
...
library(stringr)
library(statmod)
my_count_matrix <- read.csv("01.raw.count.pho2LP-myc_vs_mock.tab", sep = "\t", header=T)
