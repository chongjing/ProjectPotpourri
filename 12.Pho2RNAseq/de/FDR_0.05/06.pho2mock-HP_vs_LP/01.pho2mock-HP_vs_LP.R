...
setwd("/rds/user/cx264/hpc-work/project/2.Jeongmin/01.Saskia//4.DEanalysis.FDR_0.05/06.pho2mock-HP_vs_LP/")
...
library(stringr)
library(statmod)
my_count_matrix <- read.csv("../../4.DEanalysis.FDR_0.01/06.pho2mock-HP_vs_LP/01.raw.count.pho2mock-HP_vs_LP.tab", sep = "\t", header=T)
...
EnhancedVolcano(deseq_results, lab = rownames(deseq_results), x = 'logFC', y = 'PValue', pCutoff = 0.05, 
    FCcutoff=1.0, ylim = c(0, 6), xlim = c(-10, 10), pointSize = 1.0, labSize = 0, 
