...
setwd("/rds/user/cx264/hpc-work/project/2.Jeongmin/01.Saskia//4.DEanalysis.FDR_0.05/11.HPmock-WT_vs_pho2/")
...
library(stringr)
library(statmod)
my_count_matrix <- read.csv("../../4.DEanalysis.FDR_0.01/11.HPmock-WT_vs_pho2/01.raw.count.HPmock-WT_vs_pho2.tab", sep = "\t", header=T)
