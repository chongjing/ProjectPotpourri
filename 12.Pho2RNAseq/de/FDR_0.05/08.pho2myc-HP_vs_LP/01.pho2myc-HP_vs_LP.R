...
setwd("/rds/user/cx264/hpc-work/project/2.Jeongmin/01.Saskia//4.DEanalysis.FDR_0.05/08.pho2myc-HP_vs_LP/")
...
library(stringr)
library(statmod)
my_count_matrix <- read.csv("../../4.DEanalysis.FDR_0.01/08.pho2myc-HP_vs_LP/01.raw.count.pho2myc-HP_vs_LP.tab", sep = "\t", header=T)
